...
const Topbar = () => {
    //TODO: add links
    return (
        <div className="flex items-center justify-center bg-[var(--color-secondary)] w-full py-1 sm:py-2 gap-1 sm:gap-3">
            <span className="text-white text-xs sm:text-sm md:text-base">
                Микола
            </span>
            <Image className="mx-1 sm:mx-2 max-sm:w-4 max-sm:h-4" quality={100} alt="kyivstar logo" src="/icons/kyivstar.png" width={32} height={32} />
            ...
            <a href="https://api.whatsapp.com/send?phone=380982275197" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
                <Image className="mx-1 sm:mx-2 max-sm:w-4 max-sm:h-4" quality={100} alt="whatsapp logo" src="/icons/whatsapp.png" width={32} height={32} />
            </a>
